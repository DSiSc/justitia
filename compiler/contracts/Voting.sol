...
contract CandidateManage {
    ...
    function GetCandidateByRanking(uint ranking) public view returns(address, string, uint){
        require(isCandidate(CandidateList[ranking]));
        return (candidateLookup[CandidateList[ranking]].account, candidateLookup[CandidateList[ranking]].url, candidateLookup[CandidateList[ranking]].id);
    }

    // apply to candidate
    function ApplyToCandidate(address applicant, uint pledge, string memo, string url) public returns(bool, string){
        require(!isCandidate(applicant));

        string memory errors;
        if(!candidateCriteria(applicant, pledge)){
            errors = "errors: some criterias not met.";
            emit ApplyToCandidateEvent(applicant, memo, false, errors);
            return (false, errors);
        }
        ...
        candidateLookup[applicant].id = uniqeId;
        ...
        emit ApplyToCandidateEvent(applicant, memo, true, errors);
        return (true, errors);
    }
...
*/
contract Voting is CandidateManage, BlackListManage {
    ...
    constructor () public {
        ...
        ApplyToCandidate(0x86edb13de37acc08110a3516e09b762245254b24, 200, "first", "172.0.0.0:47768");
        ApplyToCandidate(0xff0f61bc6044021512ebd584dd26e74fb38a4928, 201, "first", "172.0.0.1:47768");
        ApplyToCandidate(0x563ce264a98480c0c992431737b2d23b046b71b7, 199, "first", "172.0.0.2:47768");
        ApplyToCandidate(0xb39916591fb877e55e1fe647372cdbddccc6c3d3, 202, "first", "172.0.0.3:47768");
    }
