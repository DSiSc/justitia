...
func Test_NewNodeConfig(t *testing.T) {
	...
	assert.Equal(int64(50000), nodeConf.ConsensusConf.Timeout.TimeoutToCollectResponseMsg)
	assert.Equal(int64(60000), nodeConf.ConsensusConf.Timeout.TimeoutToWaitCommitMsg)
